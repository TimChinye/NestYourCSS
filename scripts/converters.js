export function minimizeCSS(cssProvided) {
    const extracted = [];
...
export function splitCSS(cssProvided) {
...
export function flattenCSS(cssProvided, prefix = '') {
    /**
...
export function denestCSS(cssProvided) {
    let parsedCSS = [];
...
export function renestCSS(cssProvided, withHtml) {
...
export function beautifyCSS(cssProvided, indent = '') {
